...
define( 'SLIDEDECK3_ADDONS_DIR',                     WP_PLUGIN_DIR . "/slidedeck-addons" );
...
define( 'SLIDEDECK2_UPDATE_SITE',                    'http://update.slidedeck.com/update-slidedeck3-com' );
define( 'SLIDEDECK2_RENEWAL_URL',                    'http://www.slidedeck.com/?post_type=product&add-to-cart=13323' );

// define blank image
define( 'SLIDEDECK2_BLANK_IMAGE',                    esc_url( plugins_url( '../images/blank.gif', __FILE__ ) ));
