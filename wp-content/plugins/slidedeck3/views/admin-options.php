                ...
                <formset>
                    <div class="inner">
                        ...
                        <ul>
                            ...
                            <li>
                                <?php slidedeck2_html_input( 'data[slidedeck_align_center]', $data['slidedeck_align_center'], array( 'attr' => array( 'class' => 'fancy' ), 'type' => 'radio', 'label' => "Align SlideDeck in the center" ) ); ?>
                            </li>
                            <li>
