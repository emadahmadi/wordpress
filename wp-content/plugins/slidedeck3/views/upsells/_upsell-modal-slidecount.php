	...
	<div class="background">
		<div class="inner">
			...
			<div class="cta">
				...
				<a class="features-link" href="http://www.slidedeck.com/features?utm_campaign=sd3_lite&utm_medium=handslap_link&utm_source=handslap_slide_count&utm_content=summer_vacation_three_covers<?php echo self::get_cohort_query_string('&'); ?>" target="_blank">or learn more about other SlideDeck features</a>
			</div>
		</div>
	</div>
</div>