    ...
    <div class="background">
        <div class="inner">
            ...
            <div class="cta">
                ...
                <a class="features-link" href="http://demo.slidedeck.com/wp-login.php?utm_campaign=sd3_lite&utm_medium=handslap_link&utm_source=handslap_slide_type&utm_content=html_slide<?php echo self::get_cohort_query_string('&') . slidedeck2_km_link(); ?>" target="_blank">or try it out in the live demo</a>
            </div>
        </div>
    </div>
</div>