...
<?php foreach( $premium_lenses as $slug => $lens_meta ): ?>
    ...
    <?php if( !in_array( 'fashion', $lens_slugs ) ) : ?>
        ...
        <a href="http://www.slidedeck.com/lenses-ae69de/?lens=<?php echo $slug; ?>&utm_source=premium_lenses_tab&utm_medium=link&utm_content=<?php echo $lens_meta['utm_content']; ?>&utm_campaign=sd3_lite<?php echo self::get_cohort_query_string('&') . slidedeck2_km_link( 'Browse Premium Lens', array( 'name' => $lens_meta['name'], 'location' => 'Lens Choices Tab' ) ); ?>" target="_blank" class="lens placeholder" rel="lenses">
...
<div class="upgrade-license-lenses">
    ...
    <span class="shadow">&nbsp;</span>
    <span class="title">Get more Lenses</span>
</div>