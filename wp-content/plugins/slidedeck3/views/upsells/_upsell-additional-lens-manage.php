        ...
        <div class="lens add-lens">
            <div class="inner">
                ...
                <div class="upgrade-button-cta">
                    <a href="http://www.slidedeck.com/lenses-ae69de/?lens=<?php echo $slug; ?>&utm_source=premium_lenses_page&utm_medium=link&utm_content=<?php echo $lens_meta['utm_content']; ?>&utm_campaign=sd3_lite<?php echo self::get_cohort_query_string('&') . slidedeck2_km_link( 'Browse Premium Lens', array( 'name' => $lens_meta['name'], 'location' => 'Lens Management' ) ); ?>" target="_blank" class="upgrade-button green">
