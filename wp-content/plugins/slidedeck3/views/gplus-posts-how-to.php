...
<div class="wrapper">
    <div class="inner">
        ...
        <dl class="slidedeck" id="gplus-posts-how-to">
            ...
            <dd>
                <div class="section">
                    <h3><?php _e( "Copy your API Key then paste it into SlideDeck 3", $namespace ); ?></h3>
                    <p><?php _e( "Click the API Access menu at the top left and copy your API Key! We&rsquo;ll automatically save your key so it will be pre-populated for your next SlideDeck 3.", $namespace ); ?></p>
