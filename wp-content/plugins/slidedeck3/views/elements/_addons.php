...
<div class="lens">
    ...
    <div class="inner">
		...
		<h4><?php echo $addon['meta']['name']; ?></h4>
    ...
    <div class="actions">
        <form action="" method="post">
			...
			if ( $is_addon_activated ) {
				?>
				<a href="<?php echo slidedeck2_action( "/addons&action=deactivate&slidedeck-addon=". $addon_slug ); ?>" class="deactivate-addon">Deactivate</a>
			<?php
			} else { ?>
				<a href="<?php echo slidedeck2_action( "/addons&action=activate&slidedeck-addon=". $addon_slug ); ?>" class="deactivate-addon">Activate</a>
			<?php }
			?>
