...
class SlideDeckLens {
    ...
    function get_meta( $filename ) {
        ...
        if( $lens == false ) {
			...
			// css for mobile
            if( file_exists( $lens_folder . "/lens.mobile.css" ) ) {
                $lens['lens_mobile'] = $lens_url . "/lens.mobile.css";
            }
			
			// css for tablet
            if( file_exists( $lens_folder . "/lens.tablet.css" ) ) {
                $lens['lens_tablet'] = $lens_url . "/lens.tablet.css";
            }
