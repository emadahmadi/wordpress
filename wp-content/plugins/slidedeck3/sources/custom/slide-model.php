...
class SlideDeckSlideModel {
    ...
    var $description = "Slides for Custom SlideDeck 3 SlideDecks";
    var $label = "SlideDeck 3 Custom Slides";
    ...
    function get_meta( $slide_id, $cached = true ) {
        ...
        if( !isset( $meta['_preferred_image_size'] ) ) {
            $meta['_preferred_image_size'] = "auto";
        }
