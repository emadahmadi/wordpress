...
$username_hidden = ( $slidedeck['options']['search_or_user'] != 'user' ) ? ' style="display: none;"' : '';
$search_hidden = ( $slidedeck['options']['search_or_user'] != 'search' ) ? ' style="display: none;"' : '';
$channelid_hidden = ( $slidedeck['options']['search_or_user'] != 'channel_id' ) ? ' style="display: none;"' : '';
?>
        ...
        <ul class="content-source-fields">
            <li>
                <?php slidedeck2_html_input( 'options[search_or_user]', $slidedeck['options']['search_or_user'], array( 'type' => 'radio', 'label' => __( "Videos From", $this->namespace ), 'attr' => array( 'class' => 'fancy' ), 'values' => array( 
                    ...
                    'channel_id' => __( "Channel ID", $this->namespace )
                 ) ) ); ?>
            </li>
            ...
            <li class="youtube-username"<?php echo $username_hidden; ?>>
                <?php slidedeck2_html_input( 'options[youtube_username]', $slidedeck['options']['youtube_username'], array( 'label' => __( "Username", $this->namespace ), 'attr' => array( 'size' => 20, 'maxlength' => 255 ), 'required' => true ) ); ?>
                <a class="youtube-username-ajax-update button" href="#update"><?php _e( "Update", $this->namespace ); ?></a>
            </li>
			<li class="youtube-channelid"<?php echo $channelid_hidden; ?>>
                <?php slidedeck2_html_input( 'options[youtube_channel]', $slidedeck['options']['youtube_channel'], array( 'label' => __( "Channel ID", $this->namespace ), 'attr' => array( 'size' => 20, 'maxlength' => 255 ), 'required' => true ) ); ?>
                <a class="youtube-channel-ajax-update button" href="#update"><?php _e( "Update", $this->namespace ); ?></a>
            </li>
            <li class="youtube-playlist"<?php echo $username_hidden; ?>>
