...
(function($){
    window.SlideDeck = function(el,opts){
                ...
                if(jQuery(".slidedeck-frame.lens-vanilla.sd2-fullwidth").find("dd") && !jQuery(".slidedeck-frame").hasClass("lens-classic"))
		{
            ...
            switch(transition){
                ...
                default:
                    ...
                    if(! $(self.slides.parent().parent() ).is(".display-nav-hover")){
                    ...
                    if(self.options.device_width > 700 ){
                        ...
                        if($(thisParent).parent().is('.lens-classic')){ 
                            if($(thisParent).parent().is('.display-nav-always')){
                                ...
                                $('.slide img').css('left',(self.spines.index(this)+1)*spinesWidthsNow+'px');//testing
        ...
        var transitions = {
			...
			pos =  (slide_width -((self.slides.length-i) * spine_outer_width)); // for last slide : By Niranjan.
                    ...
                    jQuery('.slide img').css('left',(self.current * spine_outer_width));
